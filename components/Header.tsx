      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4 lg:px-8">
        <Link href="/" className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-zinc-500">{t.nav.tagline}</p>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="rounded-full border border-zinc-200 bg-white px-4 py-3 text-sm font-black text-zinc-900 transition hover:border-green-300"
          >
            {isArabic ? "EN" : "عربي"}
          </button>
          ...
          <Link
            href="/admin-login"
            className="hidden rounded-full border border-zinc-200 bg-white px-5 py-3 text-sm font-black text-zinc-900 transition hover:border-red-300 hover:text-red-600 md:inline-flex"
          >
            Admin
          </Link>
